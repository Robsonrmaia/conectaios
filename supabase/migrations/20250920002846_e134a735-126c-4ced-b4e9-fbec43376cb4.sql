...
('gamification_enabled', '"true"'::jsonb, 'Enable/disable gamification system'),
('gamification_rollout_phase', '"general"'::jsonb, 'Rollout phase: beta, pilot, or general'),
('gamification_beta_brokers', '[]'::jsonb, 'Array of broker IDs in beta phase'),
('gamification_pilot_brokers', '[]'::jsonb, 'Array of broker IDs in pilot phase')
