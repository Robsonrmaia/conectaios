-- FASE FINAL: Adicionar dados de exemplo
...
(
  ...
  'loft',
  'public_site',
  'Loft com estilo industrial no bairro criativo da Vila Madalena. Pé direito alto, estrutura aparente, perfect para profissionais criativos ou jovens casais modernos.',
  ARRAY[
...
(
  ...
  'sala_comercial',
  'public_site',
  'Sala comercial em edifício corporativo classe A. Infraestrutura completa com ar condicionado central, elevadores de alta velocidade e segurança 24h.',
  ARRAY[
...
(
  ...
  'terreno',
  'match_only',
  'Terreno plano com excelente potencial construtivo. Zoneamento permite construção de edifício residencial ou comercial. Localização estratégica próxima a principais vias de acesso.',
  ARRAY[
    'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&h=600&fit=crop'
  ],
  ARRAY[],
  'Rua dos Três Irmãos, 800',
  'Vila Progredior',
  'São Paulo',
  'SP',
  0,
