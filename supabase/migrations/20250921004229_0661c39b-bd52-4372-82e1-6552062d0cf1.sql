-- Correção completa do minisite da Gisele - versão simplificada
...
-- 4. Atualizar ou criar configuração do minisite
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM minisite_configs WHERE broker_id = '08ab7af3-2128-4af7-a078-0a078d608901') THEN
