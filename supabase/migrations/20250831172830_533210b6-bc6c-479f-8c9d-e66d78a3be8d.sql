...
-- Add sample partnerships with valid logo URLs
...
('Creci-BA', 'https://via.placeholder.com/200x100/0066cc/ffffff?text=CRECI-BA', 'https://creci-ba.gov.br', true),
('Prefeitura de Ilhéus', 'https://via.placeholder.com/200x100/228B22/ffffff?text=PREFEITURA', 'https://ilheus.ba.gov.br', true);