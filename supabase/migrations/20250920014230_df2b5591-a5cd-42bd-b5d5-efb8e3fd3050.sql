-- Clean up old inconsistent gamification rules and add correct ones
DELETE FROM public.gam_points_rules WHERE key IN (
  'anuncio_vendido_alugado',
  'anuncio_qualidade_90', 
  'anuncio_8_fotos',
...
-- Insert all 11 gamification rules with consistent keys
