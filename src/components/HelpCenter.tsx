    ...
    faqs: [
      {
        ...
        answer: 'Temos 3 planos em promoção (50% OFF nos 3 primeiros meses): Básico (R$ 49 → R$ 98): Até 20 imóveis, CRM completo, matches ilimitados, chat em tempo real, multi ferramentas e minisite personalizado. Profissional (R$ 79 → R$ 148): Até 50 imóveis, tudo do Básico, ferramentas avançadas e 2 imóveis publicados no OLX. Premium (R$ 99 → R$ 198): Até 100 imóveis, tudo do Profissional e 5 imóveis no OLX com destaque no topo.',
