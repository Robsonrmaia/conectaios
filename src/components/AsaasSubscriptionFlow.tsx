      ...
      <Card className="max-w-md mx-auto">
        <CardContent className="pt-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className={`flex items-center gap-2 ${processingStep >= 1 ? 'text-success' : 'text-muted-foreground'}`}>
              ...
              <div className={`flex items-center gap-2 ${processingStep >= 2 ? 'text-success' : 'text-muted-foreground'}`}>
                {processingStep > 2 ? <Check className="h-4 w-4" /> : processingStep === 2 ? <Loader2 className="h-4 w-4 animate-spin" /> : <div className="h-4 w-4" />}
                <span className="text-sm">Criando assinatura</span>
              </div>
              <div className={`flex items-center gap-2 ${processingStep >= 3 ? 'text-success' : 'text-muted-foreground'}`}>
