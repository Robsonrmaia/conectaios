...
import { Building2, Plus, Search, Filter, MapPin, Bath, Bed, Car, Edit, Trash2, Home, Upload, Eye, Globe, FileImage, EyeOff, Wand2, Sparkles, Volume2, Droplet, Palette, Target, Zap, ChevronDown } from 'lucide-react';
              ...
              <Card key={property.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3 mt-4">
                    <Collapsible open={!collapsedProperties.has(property.id)} onOpenChange={() => togglePropertyCollapse(property.id)}>
                      <CollapsibleTrigger asChild>
                        <Button variant="ghost" size="sm" className="w-full justify-between mb-2">
                          ...
                          <ChevronDown className={`h-3 w-3 transition-transform ${collapsedProperties.has(property.id) ? 'rotate-180' : ''}`} />
                        </Button>
                      </CollapsibleTrigger>
